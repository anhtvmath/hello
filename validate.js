    ...
    username = new Array("Trần Việt Anh","u49","u50");
    password = new Array("12345","p49","p50");
    customer = new Array("Lê Anh","c2","c3");
    if (tensinhvien == customer[0] || tensinhvien == customer[1] || tensinhvien == customer[2])
    {
    alert("Tài khoản của bạn đã hết hạn sử dụng. Xin vui lòng đăng ký để sử dụng phần mềm!");
    }
    if (tensinhvien == username[0] && masinhvien == password[0] || 
    tensinhvien == username[1] && masinhvien == password[1] || 
    tensinhvien == username[2] && masinhvien == password[2]) {
